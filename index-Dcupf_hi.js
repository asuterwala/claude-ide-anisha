...
const initialState = {
  ...
  splitTabId: null,
  behavior: {
    featuresUsed: /* @__PURE__ */ new Set(),
    firstTerminalAt: null,
    isFirstLaunch: false,
    firedTipIds: /* @__PURE__ */ new Set(),
    triggeredTips: []
  },
...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "CLOSE_TAB": {
      const tabs = state.tabs.filter((t2) => t2.id !== action.tabId);
      const activeTabId = state.activeTabId === action.tabId ? tabs[tabs.length - 1]?.id ?? "dashboard" : state.activeTabId;
    ...
    case "SET_TAB_DIRTY":
      return { ...state, tabs: state.tabs.map((t2) => t2.id === action.tabId ? { ...t2, isDirty: action.isDirty } : t2) };
    case "UPDATE_TAB_LABEL":
      return { ...state, tabs: state.tabs.map((t2) => t2.id === action.tabId ? { ...t2, label: action.label } : t2) };
    case "SET_SPLIT_TAB":
...
function useClaudeStatus() {
  ...
  reactExports.useEffect(() => {
    ...
    const unsubscribe = window.api.onPtyData((id2, data) => {
      if (id2 !== activeTab.ptyId) return;
...
function evaluateTips(ctx, firedIds) {
...
function TabBar() {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      const tab = {
        id: id2,
        type: "terminal",
        label: `Terminal ${state.tabs.filter((t2) => t2.type === "terminal").length + 1}`,
        closeable: true,
        ptyId,
  ...
  const handleSplit = reactExports.useCallback((e, tab) => {
    e.stopPropagation();
  ...
  const handleClose = (e, tabId) => {
    e.stopPropagation();
    const tab = state.tabs.find((t2) => t2.id === tabId);
    if (tab?.ptyId) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    state.tabs.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: tabColors[tab.type], fontSize: 10 }, children: "●" }),
          tab.label,
          tab.isDirty && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--accent-primary)" }, children: "●" }),
          tab.type === "editor" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          tab.closeable && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function useFileTree(projectPath) {
  ...
  const [gitStatuses, setGitStatuses] = reactExports.useState({});
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
            status && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: gitBadgeColors[status], fontSize: 11 }, children: gitBadgeLetters[status] }),
            !node.isDirectory && node.size != null && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666", fontSize: 11 }, children: formatSize(node.size) })
          ] })
        ]
      }
    ),
    expanded && children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      FileTreeNode,
      {
        node: child,
        depth: depth + 1,
...
function FileExplorer() {
  ...
  const handleFileClick = (filePath, fileName) => {
    const existing = state.tabs.find((t2) => t2.filePath === filePath);
    if (existing) {
...
(function(module, exports$1) {
  !function(e, t2) {
    ...
    var e = { 4567: function(e2, t3, i2) {
      ...
      const n2 = i2(9042), o = i2(9924), a = i2(844), h2 = i2(4725), c = i2(2585), l2 = i2(3656);
      ...
      t3.AccessibilityManager = d = s2([r2(1, c.IInstantiationService), r2(2, h2.ICoreBrowserService), r2(3, h2.IRenderService)], d);
    }, 3614: (e2, t3) => {
      function i2(e3) {
        return e3.replace(/\r?\n/g, "\r");
      }
      ...
      const n2 = i2(3656), o = i2(8460), a = i2(844), h2 = i2(2585), c = i2(4725);
      ...
      t3.Linkifier = l2 = s2([r2(1, c.IMouseService), r2(2, c.IRenderService), r2(3, h2.IBufferService), r2(4, c.ILinkProviderService)], l2);
    }, 9042: (e2, t3) => {
          ...
          for (let t5 = 0; t5 < a2; t5++) if (-1 !== l2 || i3.hasContent(t5)) {
            ...
            if (d || -1 !== l2 && t5 === a2 - 1) {
              ...
              if (i4) {
                ...
                o3 || s3.push({ text: i4, range: n3, activate: (e4, t6) => r3 ? r3.activate(e4, t6, n3) : h2(0, t6), hover: (e4, t6) => r3?.hover?.(e4, t6, n3), leave: (e4, t6) => r3?.leave?.(e4, t6, n3) });
              }
...
WARNING: This link could potentially be dangerous`)) {
      ...
      const n2 = i2(5871), o = i2(4725), a = i2(844), h2 = i2(2585), c = { full: 0, left: 0, center: 0, right: 0 }, l2 = { full: 0, left: 0, center: 0, right: 0 }, d = { full: 0, left: 0, center: 0, right: 0 };
      let _2 = t3.OverviewRulerRenderer = class extends a.Disposable {
        get _width() {
          return this._optionsService.options.overviewRulerWidth || 0;
        }
        constructor(e3, t4, i3, s3, r3, o2, h3) {
      ...
      t3.OverviewRulerRenderer = _2 = s2([r2(2, h2.IBufferService), r2(3, h2.IDecorationService), r2(4, o.IRenderService), r2(5, h2.IOptionsService), r2(6, o.ICoreBrowserService)], _2);
      ...
      const n2 = i2(3787), o = i2(2550), a = i2(2223), h2 = i2(6171), c = i2(6052), l2 = i2(4725), d = i2(8055), _2 = i2(8460), u2 = i2(844), f2 = i2(2585), v2 = "xterm-dom-renderer-owner-", p2 = "xterm-rows", g = "xterm-fg-", m2 = "xterm-bg-", S2 = "xterm-focus", C2 = "xterm-selection";
      ...
      class i2 {
        ...
        update(e3, t4, i3, s2 = false) {
          ...
          const r2 = e3.buffers.active.ydisp, n2 = t4[1] - r2, o = i3[1] - r2, a = Math.max(n2, 0), h2 = Math.min(o, e3.rows - 1);
          a >= e3.rows || h2 < 0 ? this.clear() : (this.hasSelection = true, this.columnSelectMode = s2, this.viewportStartRow = n2, this.viewportEndRow = o, this.viewportCappedStartRow = a, this.viewportCappedEndRow = h2, this.startCol = t4[0], this.endCol = i3[0]);
        }
      ...
      const n2 = i2(6193), o = i2(4725), a = i2(8460), h2 = i2(844), c = i2(7226), l2 = i2(2585);
      ...
      t3.NULL_COLOR = { css: "#00000000", rgba: 0 }, function(e3) {
        ...
        e3.blend = function(e4, t5) {
          ...
          const a2 = t5.rgba >> 24 & 255, h3 = t5.rgba >> 16 & 255, c2 = t5.rgba >> 8 & 255, l3 = e4.rgba >> 24 & 255, d2 = e4.rgba >> 16 & 255, _3 = e4.rgba >> 8 & 255;
          return i2 = l3 + Math.round((a2 - l3) * n2), s2 = d2 + Math.round((h3 - d2) * n2), r2 = _3 + Math.round((c2 - _3) * n2), { css: o.toCss(i2, s2, r2), rgba: o.toRgba(i2, s2, r2) };
        ...
        e3.toColor = function(e4) {
          ...
          if (h3) return i2 = parseInt(h3[1]), s2 = parseInt(h3[2]), r2 = parseInt(h3[3]), n2 = Math.round(255 * (void 0 === h3[5] ? 1 : parseFloat(h3[5]))), o.toColor(i2, s2, r2, n2);
        ...
        function t4(e4, t5, i3) {
          ...
          let o2 = t5 >> 24 & 255, a3 = t5 >> 16 & 255, h3 = t5 >> 8 & 255, l3 = _2(c.relativeLuminance2(o2, a3, h3), c.relativeLuminance2(s3, r3, n3));
          for (; l3 < i3 && (o2 > 0 || a3 > 0 || h3 > 0); ) o2 -= Math.max(0, Math.ceil(0.1 * o2)), a3 -= Math.max(0, Math.ceil(0.1 * a3)), h3 -= Math.max(0, Math.ceil(0.1 * h3)), l3 = _2(c.relativeLuminance2(o2, a3, h3), c.relativeLuminance2(s3, r3, n3));
          return (o2 << 24 | a3 << 16 | h3 << 8 | 255) >>> 0;
        }
        function a2(e4, t5, i3) {
          const s3 = e4 >> 24 & 255, r3 = e4 >> 16 & 255, n3 = e4 >> 8 & 255;
          let o2 = t5 >> 24 & 255, a3 = t5 >> 16 & 255, h3 = t5 >> 8 & 255, l3 = _2(c.relativeLuminance2(o2, a3, h3), c.relativeLuminance2(s3, r3, n3));
          for (; l3 < i3 && (o2 < 255 || a3 < 255 || h3 < 255); ) o2 = Math.min(255, o2 + Math.ceil(0.1 * (255 - o2))), a3 = Math.min(255, a3 + Math.ceil(0.1 * (255 - a3))), h3 = Math.min(255, h3 + Math.ceil(0.1 * (255 - h3))), l3 = _2(c.relativeLuminance2(o2, a3, h3), c.relativeLuminance2(s3, r3, n3));
          return (o2 << 24 | a3 << 16 | h3 << 8 | 255) >>> 0;
        }
        e3.blend = function(e4, t5) {
          if (n2 = (255 & t5) / 255, 1 === n2) return t5;
          const a3 = t5 >> 24 & 255, h3 = t5 >> 16 & 255, c2 = t5 >> 8 & 255, l3 = e4 >> 24 & 255, d2 = e4 >> 16 & 255, _3 = e4 >> 8 & 255;
          return i2 = l3 + Math.round((a3 - l3) * n2), s2 = d2 + Math.round((h3 - d2) * n2), r2 = _3 + Math.round((c2 - _3) * n2), o.toRgba(i2, s2, r2);
        }, e3.ensureContrastRatio = function(e4, i3, s3) {
          const r3 = c.relativeLuminance(e4 >> 8), n3 = c.relativeLuminance(i3 >> 8);
          if (_2(r3, n3) < s3) {
            if (n3 < r3) {
              const n4 = t4(e4, i3, s3), o3 = _2(r3, c.relativeLuminance(n4 >> 8));
              if (o3 < s3) {
                const t5 = a2(e4, i3, s3);
                return o3 > _2(r3, c.relativeLuminance(t5 >> 8)) ? n4 : t5;
              }
              return n4;
            }
            ...
            if (h3 < s3) {
              ...
              return h3 > _2(r3, c.relativeLuminance(n4 >> 8)) ? o2 : n4;
            }
            return o2;
          }
      ...
      }(l2 || (t3.rgba = l2 = {})), t3.toPaddedHex = d, t3.contrastRatio = _2;
    }, 8969: (e2, t3, i2) => {
      ...
      const n2 = i2(2584), o = i2(7116), a = i2(2015), h2 = i2(844), c = i2(482), l2 = i2(8437), d = i2(8460), _2 = i2(643), u2 = i2(511), f2 = i2(3734), v2 = i2(2585), p2 = i2(1480), g = i2(6242), m2 = i2(6351), S2 = i2(5941), C2 = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 }, b = 131072;
      function w2(e3, t4) {
      ...
      class k2 extends h2.Disposable {
        ...
        print(e3, t4, i3) {
          let s3, r3;
          const n3 = this._charsetService.charset, o2 = this._optionsService.rawOptions.screenReaderMode, a2 = this._bufferService.cols, h3 = this._coreService.decPrivateModes.wraparound, d2 = this._coreService.modes.insertMode, u3 = this._curAttrData;
          ...
          for (let g2 = t4; g2 < i3; ++g2) {
            ...
            } else if (d2 && (f3.insertCells(this._activeBuffer.x, r3 - m3, this._activeBuffer.getNullCell(u3)), 2 === f3.getWidth(a2 - 1) && f3.setCellFromCodepoint(a2 - 1, _2.NULL_CELL_CODE, _2.NULL_CELL_WIDTH, u3)), f3.setCellFromCodepoint(this._activeBuffer.x++, s3, r3, u3), r3 > 0) for (; --r3; ) f3.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, u3);
          }
        ...
        *getDecorationsAtCell(e3, t4, i3) {
        ...
        forEachDecorationAtCell(e3, t4, i3, s3) {
          this._decorations.forEachByKey(t4, (t5) => {
            a = t5.options.x ?? 0, h2 = a + (t5.options.width ?? 1), e3 >= a && e3 < h2 && (!i3 || (t5.options.layer ?? "bottom") === i3) && s3(t5);
          });
        }
      }
...
function useConfig() {
  ...
  reactExports.useEffect(() => {
    if (!state.config) {
      window.api.loadConfig().then((config2) => {
        dispatch({ type: "CONFIG_LOADED", payload: config2 });
      });
    }
...
const SILENCE_MS = 3e4;
function useNotification() {
  const { state } = useAppState();
  const config2 = useConfig();
  const lastOutputRef = reactExports.useRef("");
  const silenceUntilRef = reactExports.useRef(0);
  ...
  const checkAndNotify = reactExports.useCallback((terminalOutput) => {
    if (!config2?.notifications?.enabled) return;
    if (!state.notifications.enabled) return;
    if (Date.now() < silenceUntilRef.current) return;
    if (config2.notifications.quietHoursStart && config2.notifications.quietHoursEnd) {
      const now = /* @__PURE__ */ new Date();
      const hour = now.getHours();
      const start = parseInt(config2.notifications.quietHoursStart.split(":")[0]);
      const end = parseInt(config2.notifications.quietHoursEnd.split(":")[0]);
      if (start > end) {
    ...
    cleanup();
    const isWaiting = !lastLine.endsWith("$") && !lastLine.endsWith(">") && !lastLine.endsWith("%") && (lastLine.endsWith("?") || lastLine.includes("[Y/n]") || lastLine.includes("[y/N]") || lastLine.includes("(yes/no)") || lastLine.includes("Allow?"));
    if (isWaiting) {
  ...
  }, [config2?.notifications, state.notifications.enabled, cleanup]);
  return { checkAndNotify, cleanup };
}
function TerminalTab({ ptyId, visible }) {
  const containerRef = reactExports.useRef(null);
  const terminalRef = reactExports.useRef(null);
  const fitAddonRef = reactExports.useRef(null);
  const terminalBufferRef = reactExports.useRef("");
  ...
  reactExports.useEffect(() => {
    ...
    const unsubData = window.api.onPtyData((id2, data) => {
      if (id2 === ptyId) {
        terminal.write(data);
        terminalBufferRef.current += data;
        if (terminalBufferRef.current.length > 1e4) {
          terminalBufferRef.current = terminalBufferRef.current.slice(-1e4);
        }
      ...
      children: [
        ...
        isDragging && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: "Drop file to insert path"
          }
        )
      ]
    }
...
function EditorTab({ tabId, filePath, visible }) {
  ...
  const [inlinePrompt, setInlinePrompt] = reactExports.useState("");
  const [inlineLoading, setInlineLoading] = reactExports.useState(false);
  const inlineInputRef = reactExports.useRef(null);
  const loadFile = reactExports.useCallback(async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: "100%", height: "100%", display: visible ? "block" : "none", position: "relative" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ft,
      {
    ...
    inlineEdit && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4fc1ff", fontSize: 12, fontWeight: "bold", flexShrink: 0 }, children: inlineLoading ? "⏳" : "⌘K" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ref: inlineInputRef,
          ...
          !inlineLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              onClick: () => {
                setInlineEdit(null);
  ...
  for (let attempt = 0; attempt < maxAttempts; attempt++) {
    try {
      ...
      if (attempt < maxAttempts - 1) {
        await new Promise((r2) => setTimeout(r2, Math.pow(2, attempt) * 1e3));
      }
    }
  }
  throw lastError;
...
function TodayPanel() {
  ...
  const [hadMeetingsToday, setHadMeetingsToday] = reactExports.useState(false);
  const [cacheStale, setCacheStale] = reactExports.useState(false);
  const [calendarRefreshing, setCalendarRefreshing] = reactExports.useState(false);
  const [tasksRefreshing, setTasksRefreshing] = reactExports.useState(false);
  const [calendarUpdated, setCalendarUpdated] = reactExports.useState(null);
  const [tasksUpdated, setTasksUpdated] = reactExports.useState(null);
  const [refreshError, setRefreshError] = reactExports.useState(null);
  const [calendarSyncStatus, setCalendarSyncStatus] = reactExports.useState("idle");
  const [tasksSyncStatus, setTasksSyncStatus] = reactExports.useState("idle");
  const readCache = reactExports.useCallback(async () => {
    if (!config2?.notion.enabled || !config2.notion.dashboardId) return;
    dispatch({ type: "NOTION_LOADING" });
    try {
      const data = await fetchWithRetry(() => window.api.fetchNotion(config2.notion.dashboardId));
      if (data.error) {
  ...
  const handleCalendarRefresh = reactExports.useCallback(async () => {
    setCalendarRefreshing(true);
    setRefreshError(null);
    setCalendarSyncStatus("syncing");
    try {
      const cachedData = await window.api.fetchNotion(config2?.notion.dashboardId || "");
      if (!cachedData.error) {
        ...
        setCalendarUpdated(/* @__PURE__ */ new Date());
      }
      ...
      const freshData = await window.api.fetchNotion(config2?.notion.dashboardId || "");
      if (!freshData.error) {
      ...
      setTimeout(() => setCalendarSyncStatus("idle"), 5e3);
    } catch {
      setCalendarSyncStatus("failed");
  ...
  }, [config2, dispatch, state.notion]);
  const handleTasksRefresh = reactExports.useCallback(async () => {
    ...
    try {
      ...
      if (!cachedData.error) {
        ...
        setTasksUpdated(/* @__PURE__ */ new Date());
      }
      ...
      setTimeout(() => setTasksSyncStatus("idle"), 5e3);
    } catch {
      setTasksSyncStatus("failed");
  ...
  const readCacheRef = reactExports.useRef(readCache);
  readCacheRef.current = readCache;
  reactExports.useEffect(() => {
    if (config2?.notion.enabled && config2.notion.dashboardId) {
      readCache();
    }
  }, [config2?.notion.enabled, config2?.notion.dashboardId]);
  reactExports.useEffect(() => {
    if (!config2?.notion.enabled) return;
  ...
  if (!config2?.notion.enabled) return null;
  const SyncIndicator = ({ status }) => {
    if (status === "idle") return null;
    const style = { fontSize: 11, marginLeft: 6 };
    if (status === "syncing") return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { ...style, color: "var(--text-muted)" }, children: "syncing..." });
    if (status === "success") return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { ...style, color: "#22c55e" }, children: "synced" });
    if (status === "failed") return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { ...style, color: "var(--accent-error)" }, children: "sync failed" });
    return null;
  };
  const RefreshButton = ({ onClick, refreshing, title }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      onClick,
      ...
      onMouseEnter: (e) => {
        if (!loading && !refreshing) e.currentTarget.style.opacity = "1";
      },
      onMouseLeave: (e) => {
        if (!loading && !refreshing) e.currentTarget.style.opacity = "0.6";
      },
      children: refreshing ? "..." : "↻"
    }
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { margin: "0 0 12px", color: "var(--text-primary)", fontSize: 14, fontWeight: 600 }, children: "Today" }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "var(--accent-error)", fontSize: 12, marginBottom: 8 }, children: [
      error,
      cacheRef.current && " (showing cached data)"
    ] }),
    refreshError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--accent-error)", fontSize: 12, marginBottom: 8 }, children: refreshError }),
    cacheStale && !refreshError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 11, marginBottom: 8, fontStyle: "italic" }, children: "Calendar cache is stale — click refresh to update" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 16 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", marginBottom: 8 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-primary)", fontSize: 13, fontWeight: 600 }, children: "Calendar" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshButton, { onClick: handleCalendarRefresh, refreshing: calendarRefreshing, title: "Refresh calendar from Google Calendar" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SyncIndicator, { status: calendarSyncStatus })
      ] }),
      displayMeetings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 12 }, children: cacheStale ? "Calendar data outdated — refresh to see today's meetings" : hadMeetingsToday ? "No more meetings today" : "No meetings today" }) : displayMeetings.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, fontSize: 12, padding: "4px 0" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-secondary)", minWidth: 70 }, children: m2.time }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-primary)" }, children: m2.title })
      ] }, m2.id)),
      calendarUpdated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "var(--text-muted)", fontSize: 10, marginTop: 4 }, children: [
        "Updated ",
        calendarUpdated.toLocaleTimeString()
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", marginBottom: 8 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-primary)", fontSize: 13, fontWeight: 600 }, children: "Tasks" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshButton, { onClick: handleTasksRefresh, refreshing: tasksRefreshing, title: "Refresh tasks from Notion" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SyncIndicator, { status: tasksSyncStatus })
      ] }),
      displayTasks.filter((t2) => t2.status !== "Done").length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 12 }, children: "No pending tasks" }) : displayTasks.filter((t2) => t2.status !== "Done").sort((a, b) => {
        if (!a.dueDate && !b.dueDate) return 0;
        if (!a.dueDate) return 1;
        if (!b.dueDate) return -1;
        return new Date(a.dueDate).getTime() - new Date(b.dueDate).getTime();
      }).map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, fontSize: 12, padding: "4px 0" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-secondary)" }, children: "☐" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-primary)" }, children: t2.title })
      ] }, t2.id)),
      tasksUpdated && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "var(--text-muted)", fontSize: 10, marginTop: 4 }, children: [
        "Updated ",
        tasksUpdated.toLocaleTimeString()
      ] })
    ] })
  ] });
}
function ModelStatus({ projectPath }) {
  const { state, dispatch } = useAppState();
  const config2 = useConfig();
  const [nextPort, setNextPort] = reactExports.useState(config2?.streamlit.defaultPort || 8501);
  const activePath = projectPath || state.tabs.find((t2) => t2.type === "terminal")?.projectPath || "";
  const refresh = reactExports.useCallback(async () => {
    if (!activePath) return;
    const [files, apps2] = await Promise.all([
      window.api.listPythonFiles(activePath),
      window.api.getStreamlitStatus()
    ]);
    dispatch({ type: "STREAMLIT_UPDATE", payload: { pythonFiles: files, apps: apps2 } });
  }, [activePath, dispatch]);
  reactExports.useEffect(() => {
    refresh();
  ...
  const handleStop = async (file) => {
    await window.api.stopStreamlit(file);
    refresh();
  };
  if (!config2?.streamlit.enabled) return null;
  const { pythonFiles, apps } = state.streamlit;
  const streamlitFiles = pythonFiles.filter((f2) => f2.isStreamlit);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: "var(--panel-bg)", borderRadius: 8, padding: 16, border: "1px solid var(--panel-border)", boxShadow: "var(--panel-shadow)" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: { margin: "0 0 12px", color: "var(--text-primary)", fontSize: 14, fontWeight: 600 }, children: "Models" }),
    streamlitFiles.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 12 }, children: "No Streamlit apps detected. Create app.py to get started." }) : streamlitFiles.map((file) => {
      const app = apps.find((a) => a.file === file.path);
      const isRunning = app?.status === "running";
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: "1px solid var(--border-light)" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-primary)", fontSize: 13 }, children: file.name }),
          isRunning && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: "var(--accent-success)", fontSize: 11 }, children: [
            "Running on localhost:",
            app.port
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8 }, children: isRunning ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.open(`http://localhost:${app.port}`, "_blank"), style: btnStyle, children: "Open" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleStop(file.path), style: { ...btnStyle, color: "var(--accent-error)" }, children: "Stop" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => handleRun(file.path), style: btnStyle, children: "Run" }) })
      ] }, file.path);
    })
  ] });
}
...
function RecentSessions() {
  ...
  reactExports.useEffect(() => {
    window.api.getClaudeSessions?.(limit).then((data) => {
      setSessions(data);
...
`);
  ...
  if (sessions.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: panelStyle$2, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: headerStyle$2, children: "Recent Sessions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 12 }, children: "No recent sessions" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: panelStyle$2, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: headerStyle$2, children: "Recent Sessions" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxHeight: 280, overflowY: "auto" }, children: [
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 11, marginTop: 2 }, children: session.projectPath.split("/").pop() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 11, marginLeft: 12, flexShrink: 0 }, children: formatTimeAgo(session.timestamp) })
          ]
        },
        session.id
      )),
...
function SkillsLauncher() {
  const { state, dispatch } = useAppState();
  const [skills, setSkills] = reactExports.useState([]);
  reactExports.useEffect(() => {
    window.api.listSkills().then(setSkills);
  }, []);
  const executeSkill = (skillName) => {
    const cmd = `/${skillName}`;
    const terminalTab = state.tabs.find((t2) => t2.type === "terminal");
    if (terminalTab) {
  ...
  if (skills.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: panelStyle$1, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: headerStyle$1, children: "Skills" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "var(--text-muted)", fontSize: 12 }, children: "No skills found in ~/.claude/skills/" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: panelStyle$1, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: headerStyle$1, children: "Skills" }),
    skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        onMouseLeave: (e) => e.currentTarget.style.background = "transparent",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("code", { style: { color: "var(--accent-primary)", lineHeight: 1.4 }, children: [
            "/",
            skill.name
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-secondary)", lineHeight: 1.4 }, children: skill.description })
        ]
      },
      skill.name
    ))
...
const panelStyle$1 = { background: "var(--panel-bg)", borderRadius: 8, padding: 16, border: "1px solid var(--panel-border)", boxShadow: "var(--panel-shadow)" };
const headerStyle$1 = { margin: "0 0 12px", color: "var(--text-primary)", fontSize: 14, fontWeight: 600 };
const TIPS = [
...
function TipsPanel() {
  const { state } = useAppState();
  const [visibleTips, setVisibleTips] = reactExports.useState([]);
  const [expanded, setExpanded] = reactExports.useState(false);
  const hasPython = state.streamlit.pythonFiles.length > 0;
  reactExports.useEffect(() => {
    const relevantTips = TIPS.filter((t2) => t2.category !== "streamlit" || hasPython);
    const selectTips = () => {
      const shuffled = [...relevantTips].sort(() => Math.random() - 0.5);
      setVisibleTips(shuffled.slice(0, 3));
    };
    selectTips();
    const interval = setInterval(selectTips, 18e4);
    return () => clearInterval(interval);
  }, [hasPython]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: panelStyle, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: headerStyle, children: "Tips" }),
    (expanded ? TIPS.filter((t2) => t2.category !== "streamlit" || hasPython) : visibleTips).map((tip, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, padding: "6px 0", fontSize: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--accent-primary)" }, children: "💡" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-secondary)" }, children: tip.text })
    ] }, i)),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setExpanded(!expanded), style: { background: "none", border: "none", color: "var(--accent-primary)", fontSize: 11, cursor: "pointer", marginTop: 8, padding: 0 }, children: expanded ? "Show less" : "Show more" })
  ] });
}
...
function Dashboard({ visible }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { style: { margin: 0, color: "var(--text-primary)", fontSize: 24, fontWeight: 600 }, children: [
          "Welcome back",
          config2?.user.name ? `, ${config2.user.name.split(" ")[0]}` : "",
          "!"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { margin: "4px 0 0", color: "var(--text-secondary)", fontSize: 14 }, children: "Let's keep building." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "center", gap: 12 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: state.projectPath ? "Change Project" : "Open Project"
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TodayPanel, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ModelStatus, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TipsPanel, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 16 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SkillsLauncher, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(RecentSessions, {})
      ] })
    ] })
  ] });
}
function StatusBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 16, alignItems: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--text-primary)", fontWeight: 600 }, children: state.projectPath?.split("/").pop() || "No Project" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 16, alignItems: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#C2E5DF" }, children: "✦" }),
        model || "—"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F3D4F3" }, children: "§" }),
        tokens || "—"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#FFCAA4" }, children: "◎" }),
        cost || "—"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "flex", alignItems: "center", gap: 4 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#FFD1D3" }, children: "◐" }),
        context || "—"
      ] })
    ] })
  ] });
}
function QuickOpen({ visible, onClose }) {
  const { state, dispatch } = useAppState();
  ...
  reactExports.useEffect(() => {
    ...
    const scored = files.map((file) => {
      ...
      let fi2 = 0;
      for (const ch2 of parts) {
        fi2 = fileLower.indexOf(ch2, fi2);
        if (fi2 === -1) return null;
        fi2++;
      }
  ...
  const openFile = reactExports.useCallback((filePath) => {
    ...
    const existing = state.tabs.find((t2) => t2.filePath === fullPath);
    if (existing) {
      dispatch({ type: "SET_ACTIVE_TAB", tabId: existing.id });
    } else {
      const tab = {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxHeight: 340, overflowY: "auto" }, children: [
              filtered.map((file, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#e8e8e8", fontSize: 13 }, children: file.split("/").pop() }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#666", fontSize: 11 }, children: file.includes("/") ? file.substring(0, file.lastIndexOf("/")) : "" })
                  ]
                },
                file
              )),
              filtered.length === 0 && query && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "12px 16px", color: "#666", fontSize: 13 }, children: "No files found" })
            ] })
          ]
        }
      )
...
function ProjectSearch({ visible, onClose }) {
  const { state, dispatch } = useAppState();
  const [query, setQuery] = reactExports.useState("");
  ...
  const doSearch = reactExports.useCallback((q2) => {
    if (!state.projectPath || q2.length < 2) {
      setResults([]);
      return;
    }
    setSearching(true);
    window.api.searchContent(state.projectPath, q2).then((r2) => {
      setResults(r2);
      setSearching(false);
    });
  }, [state.projectPath]);
  ...
  const grouped = results.reduce((acc, r2) => {
    if (!acc[r2.file]) acc[r2.file] = [];
    acc[r2.file].push(r2);
    return acc;
  }, {});
  if (!visible) return null;
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, overflowY: "auto" }, children: [
              searching && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "12px 16px", color: "#888", fontSize: 13 }, children: "Searching..." }),
              !searching && query.length >= 2 && results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "12px 16px", color: "#666", fontSize: 13 }, children: "No results found" }),
              Object.entries(grouped).map(([file, matches]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
                  padding: "6px 16px",
                  color: "#4fc1ff",
                  fontSize: 12,
                ...
                matches.map((match, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    onMouseLeave: (e) => e.currentTarget.style.background = "transparent",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#888", flexShrink: 0, minWidth: 30, textAlign: "right" }, children: match.line }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
                        ...
                        textOverflow: "ellipsis",
                        whiteSpace: "nowrap"
                      }, children: highlightMatch(match.text, query) })
                    ]
                  },
                  `${file}:${match.line}:${i}`
                ))
...
function highlightMatch(text, query) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { background: "#613214", color: "#fff" }, children: text.substring(idx, idx + query.length) }),
...
function Toast({ message, onDismiss }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4fc1ff", fontSize: 16, lineHeight: "20px", flexShrink: 0 }, children: "💡" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
          color: "#ddd",
          fontSize: 13,
          lineHeight: "20px",
...
function App() {
  const { state, dispatch } = useAppState();
  useClaudeStatus();
  const [quickOpenVisible, setQuickOpenVisible] = reactExports.useState(false);
  const [projectSearchVisible, setProjectSearchVisible] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    const handler = (e) => {
      ...
      if (isMod && e.key === "w") {
        e.preventDefault();
        const activeTab2 = state.tabs.find((t2) => t2.id === state.activeTabId);
        if (activeTab2?.closeable) {
          if (activeTab2.ptyId) {
            window.api.destroyPty(activeTab2.ptyId);
          }
          dispatch({ type: "CLOSE_TAB", tabId: activeTab2.id });
        }
      }
      if (isMod && e.key === "t") {
        e.preventDefault();
  ...
  reactExports.useEffect(() => {
    const editorTabs = state.tabs.filter((t2) => t2.type === "editor");
  ...
  reactExports.useEffect(() => {
    const check = () => {
      ...
      const sessionDuration = state.behavior.firstTerminalAt ? Math.floor((Date.now() - state.behavior.firstTerminalAt) / 1e3) : 0;
      const ctx = {
        sessionCount: state.tabs.filter((t2) => t2.type === "terminal").length,
        sessionDuration,
        featuresUsed: state.behavior.featuresUsed,
        editorTabCount: state.tabs.filter((t2) => t2.type === "editor").length,
    ...
    const initialTimer = setTimeout(check, 5e3);
  ...
  const closeQuickOpen = reactExports.useCallback(() => setQuickOpenVisible(false), []);
  const closeProjectSearch = reactExports.useCallback(() => setProjectSearchVisible(false), []);
  const dismissToast = reactExports.useCallback(() => setCurrentToast(null), []);
  const activeTab = state.tabs.find((t2) => t2.id === state.activeTabId);
  const splitTab = state.splitTabId ? state.tabs.find((t2) => t2.id === state.splitTabId) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { height: "100vh", display: "flex", flexDirection: "column", background: "#1e1e1e" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, display: "flex", overflow: "hidden" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FileExplorer, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dashboard, { visible: state.activeTabId === "dashboard" }),
        state.tabs.filter((t2) => t2.type === "terminal" && t2.ptyId).map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          TerminalTab,
          {
            ptyId: tab.ptyId,
        ...
        activeTab?.type === "editor" || splitTab ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          flex: 1,
          display: state.tabs.some((t2) => t2.type === "editor" && (t2.id === state.activeTabId || t2.id === state.splitTabId)) ? "flex" : "none",
          overflow: "hidden"
        }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { flex: 1, overflow: "hidden" }, children: state.tabs.filter((t2) => t2.type === "editor" && t2.filePath && t2.id !== state.splitTabId).map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            EditorTab,
            {
              tabId: tab.id,
          ...
          splitTab && splitTab.type === "editor" && splitTab.filePath && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 1, background: "#3e3e3e", flexShrink: 0 } }),
          ...
          state.tabs.filter((t2) => t2.type === "editor" && t2.filePath).map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            EditorTab,
            {
              tabId: tab.id,
              filePath: tab.filePath,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(QuickOpen, { visible: quickOpenVisible, onClose: closeQuickOpen }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectSearch, { visible: projectSearchVisible, onClose: closeProjectSearch }),
    currentToast && /* @__PURE__ */ jsxRuntimeExports.jsx(Toast, { message: currentToast.message, onDismiss: dismissToast })
  ] });
}
